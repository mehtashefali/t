...
Filter By&nbsp;
<select name="Selected" id="" onchange="autosubmit();">
<option value="A" Selected>All</option>
<option value="S" <?PHP if(isset($_GET["Selected"]) and $_GET["Selected"]=="S"){ echo "Selected";} ?>> Selected </option>
<option value="N" <?PHP if(isset($_GET["Selected"]) and $_GET["Selected"]=="N"){ echo "Selected";} ?>>Not Selected</option>
</select>
</form>
</br>
...
<a href="Main.php?page=10&oid=<?php echo $row_c['_id']; ?>" class="btn btn-success">Show Application</a>
</div>
